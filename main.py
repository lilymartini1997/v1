...
def main():
    ...
    if args.llm_provider == "openai":
        ...
        # Default to Gemini 3 Pro (Preview) as it is the current high-quality model available
        llm = GeminiLLM(api_key=args.gemini_api_key, model=args.model or "gemini-3-pro-preview")
    else:
        llm = MockLLM()
